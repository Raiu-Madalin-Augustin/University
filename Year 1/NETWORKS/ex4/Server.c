...
int c;
//Write a Client Server implementation where the client sends a string to the server
//
//and the server counts the number of spaces inside the string. The problems should
//
//handle all error and abnormal cases
//
