...
public class SelectFormController implements Initializable {
    ...
    private void loadData(){
        this.programStatesView.getItems().setAll(controller.getRepository().getPrgStateList().stream().map(PrgState::getCurrentId).collect(Collectors.toList()));
        if(selectedProgram!=null)
        {
            ...
            nrProgramStatesField.setText(Integer.toString(controller.getRepository().size()));
        }
    }
