...
public class PrgState {
    ...
    public PrgState(IStack<IStmt> stack,IDict<String,IValue>dict,IList<IValue>list,IStmt statement,IDict<StringValue,BufferedReader> fileTable,Heap heap,ILatchTable st){
        this.exeStack=stack;
        this.symTable=dict;
        this.out_list=list;
