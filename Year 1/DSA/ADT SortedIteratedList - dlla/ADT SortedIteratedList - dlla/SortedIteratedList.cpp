...
void SortedIteratedList::add(TComp e) {
    ...
    if (this->relation(this->dllaList.elements[this->dllaList.tail], e)){
        ...
        while (current != -1 && this->relation(this->dllaList.elements[current], e)) {
...
} // BC: theta(1) - doesn't reach the while....WC: theta(n) -> O(n)
...
void SortedIteratedList::print(){
    ...
    while (current != -1){
        std::cout << "Element: " << this->dllaList.elements[current] << "(index: " << current << ") " " | Prev: " << this->dllaList.prev[current] << "(" << this->dllaList.elements[this->dllaList.prev[current]] << ")" << " | Next: " << this->dllaList.next[current] << endl;
        iterator.next();
        current = iterator.currentIndex;
    }
